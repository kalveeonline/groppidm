    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-br from-primary/5 via-background to-secondary/5 py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl">
              Transform your medical practice with cutting-edge digital marketing and web solutions tailored for healthcare professionals.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 px-4 bg-background">
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl font-bold mb-12 text-center text-foreground">How We Support Healthcare Providers</h2>
        ...
        <section className="py-16 px-4 bg-secondary/5">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl font-bold mb-8 text-center text-foreground">Why Digital Presence Matters in Healthcare</h2>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-primary/10 to-secondary/10">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="text-3xl font-bold mb-4 text-foreground">Ready to Grow Your Practice?</h2>
            <p className="text-xl text-muted-foreground mb-8">
              Let's discuss how our digital solutions can help you attract more patients and enhance your online reputation.
            </p>
